/**
KPOP ALBUM/ MINI ALBUM OF THE YEAR
10425723
https://secure.polldaddy.com/p/10425723.js
b395db7944b8c6295052b872e98ccf69
48110393
...
function sendVote(config, proxiedRequest, cb){
	...
	try {
		var options = {
			method: 'get',
			url: "https://polldaddy.com/n/b395db7944b8c6295052b872e98ccf69/10425723?" + Date.now(),
			headers: {
		...
		proxiedRequest(options, function (err, res, body) {
			...
			var tmp = body;
			tmp = tmp.replace("PDV_n10425723='", "");
			tmp = tmp.replace("';PD_vote10425723(0);", "");
