...
10425720
https://secure.polldaddy.com/p/10425720.js
e76f57c55e928a75f16db9271bc01485
48110377
...
function sendVote(config, proxiedRequest, cb){
	...
	try {
		var options = {
			method: 'get',
			url: "https://polldaddy.com/n/e76f57c55e928a75f16db9271bc01485/10425720?" + Date.now(),
			headers: {
		...
		proxiedRequest(options, function (err, res, body) {
			...
			var tmp = body;
			tmp = tmp.replace("PDV_n10425720='", "");
			tmp = tmp.replace("';PD_vote10425720(0);", "");
