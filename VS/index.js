/**
BLACKPINK vs GIRLSGENERATION
10414417
https://secure.polldaddy.com/p/10414417.js
79b470aab4b3a17064e9024a4571af5d
48045252
...
function sendVote(config, proxiedRequest, cb){
	...
	try {
		var options = {
			method: 'get',
			url: "https://polldaddy.com/n/79b470aab4b3a17064e9024a4571af5d/10414417?" + Date.now(),
			headers: {
		...
		proxiedRequest(options, function (err, res, body) {
			...
			var tmp = body;
			tmp = tmp.replace("PDV_n10414417='", "");
			tmp = tmp.replace("';PD_vote10414417(0);", "");
